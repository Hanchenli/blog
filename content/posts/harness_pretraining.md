...
categories: ["general"]
cover:
    image: images/harness_pretrain/main.png
...
2. From an agent deployment point of view, pretraining is a nonperfect statistical approximation of intelligence. And harness has to come to the rescue to correct the bad instincts that pretraining baked in.
...
![Harness lock-in loop](../../images/harness_pretrain/lockin.png)
...
![The harness overrides pretrained reflexes like a diver's rule overrides instinct](../../images/harness_pretrain/diver_symbolic.png)
...
![Two paths for distilling human strategies](../../images/harness_pretrain/two_paths.png)
